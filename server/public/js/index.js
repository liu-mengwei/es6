...
/***/ (function(module, exports, __webpack_require__) {
...

	{
	    ...
	    var start = regeneratorRuntime.mark(function start(count) {
	...
	{
	    var func = regeneratorRuntime.mark(function func() {
...
/***/ (function(module, exports) {
	...
	{
	    var ajax2 = function ajax2(callback) {
...

	{
	    ...
	    Promise.all([loadImage('https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/img/logo/bd_logo1_31bdc765.png'), loadImage('http://www.runoob.com/wp-content/uploads/2014/06/angular.jpg')]).then(showImage);
	}

	{
	    var a = 'meng';
	    var b = _defineProperty({}, a, 'meng');
	    console.log(b);
	}

	{
	    var obj = [1, 2, 3];
	    var _a = obj[Symbol.iterator](); //遍历器对象
	}
